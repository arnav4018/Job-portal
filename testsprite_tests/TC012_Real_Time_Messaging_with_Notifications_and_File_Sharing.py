...
async def run_test():
    ...
    try:
        ...
        # Navigate to Sign In page to log in as candidate to send message to recruiter.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/header/div/div[2]/div/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input candidate email and password and submit to log in.
        frame = context.pages[-1]
        ...
        # Navigate to messaging interface or candidate dashboard to send message to recruiter.
        frame = context.pages[-1]
        ...
        # Locate and click on messaging interface or candidate dashboard to send message to recruiter.
        frame = context.pages[-1]
