...
async def run_test():
    ...
    try:
        ...
        # Fill in the signup form with candidate details and submit.
        frame = context.pages[-1]
        ...
        # Try to submit the form by sending Enter key in the password field or the role dropdown to trigger form submission.
        frame = context.pages[-1]
