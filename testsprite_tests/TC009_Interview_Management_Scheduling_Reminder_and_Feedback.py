...
async def run_test():
    ...
    try:
        ...
        # Click on 'Sign In' to log in as recruiter to schedule an interview.
        ...
        # Navigate to the recruiter's dashboard or job applications page to schedule an interview.
        frame = context.pages[-1]
