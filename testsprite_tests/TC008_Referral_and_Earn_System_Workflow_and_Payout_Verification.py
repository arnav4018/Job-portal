...
async def run_test():
    ...
    try:
        ...
        # Navigate to candidate sign up or referral link generation page to create a unique referral link.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/header/div/div[2]/div/a[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Fill in the sign-up form with candidate details and submit to create account and generate referral link.
        frame = context.pages[-1]
